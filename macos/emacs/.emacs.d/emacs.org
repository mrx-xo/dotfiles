...
browser-style cards, org-style folding, =C-j= / =C-k= card motion (plain
=j= / =k= stay evil line motions), live refresh every 15 s while visible. Package in =lisp/voicelog.el=; =?= inside
shows every key.
#+begin_src emacs-lisp
